class_name PhotoWorld
extends ItemWorld
## World photo item: shows the captured image on its quad while on the ground.
## Acquires the ImageManager texture while it exists and releases it when freed.
...
func _apply_texture() -> void:
	...
	$photo/Plane.set_surface_override_material(1, mat)
